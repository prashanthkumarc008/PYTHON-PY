employee=[{'eid':1,'ename':'Izak','gender':'Male'},
...
# for eidd in employee:
#     print(eidd['eid'])

# for genderr in employee:
#     print(genderr['gender'])

# i=0
# while i<=len(employee)-1:
#     print(employee[i]['ename'])
#     i+=1

# to display all male/female for /in
# for emp in employee:
#     if emp['gender']=='Male':
#         print(emp['ename'])

 
# to display all male/women while loop
count=0
i=0
while i<=len(employee)-1:
    if employee[i]['gender']=='Female':
        ...
        count+=1
    i=i+1
print("Number of famales in the Dictionary: " , count)
